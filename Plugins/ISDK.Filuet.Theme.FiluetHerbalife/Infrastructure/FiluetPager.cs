...
{
    /// <summary>
    /// Renders a FiluetPager component from an IPageableModel datasource.
    /// </summary>
    public partial class FiluetPager : IHtmlContent
    {
        #region Properties
        ...
        /// <summary>
        /// First page Localization
        /// </summary>
        private string _firstPageLocalization = "Pager.First";

        /// <summary>
        /// Previous page Localization
        /// </summary>
        private string _previousPageLocalization = "Pager.Previous";

        /// <summary>
		/// Current page Localization
		/// </summary>
        private string _currentPageLocalization = "Pager.CurrentPage";

        /// <summary>
		/// Next page Localization
		/// </summary>
        private string _nextPageLocalization = "Pager.Next";

        /// <summary>
		/// Last page Localization
		/// </summary>
        private string _lastPageLocalization = "Pager.Last";
        ...
        public FiluetPager(IPageableModel model, ViewContext context)
        {
            _model = model;
            ViewContext = context;
        }
        ...
        /// <returns>FiluetPager</returns>
        public FiluetPager QueryParam(string value)
        {
            _queryParam = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowTotalSummary(bool value)
        {
        ...
        /// <summary>
        /// Set a value indicating whether to show FiluetPager items
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowPagerItems(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowFirst(bool value)
        {
            _showFirst = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowPrevious(bool value)
        {
            _showPrevious = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowNext(bool value)
        {
            _showNext = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowLast(bool value)
        {
            _showLast = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager ShowIndividualPages(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager RenderEmptyParameters(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager IndividualPagesDisplayedCount(int value)
        {
        ...
        /// <returns>FiluetPager</returns>
        public FiluetPager BooleanParameterName(string paramName)
        {
        ...
        /// <summary>
        /// Set first page FiluetPager Localization
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager FirstPageLocalization(string value)
        {
            _firstPageLocalization = value;
            return this;
        }

        /// <summary>
        /// Set previous page FiluetPager Localization
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager PreviousPageLocalization(string value)
        {
            _previousPageLocalization = value;
            return this;
        }

        /// <summary>
        /// Set current page FiluetPager Localization
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager CurrentPageLocalization(string value)
        {
            _currentPageLocalization = value;
            return this;
        }

        /// <summary>
        /// Set next page FiluetPager Localization
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager NextPageLocalization(string value)
        {
            _nextPageLocalization = value;
            return this;
        }

        /// <summary>
        /// Set last page FiluetPager Localization
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager LastPageLocalization(string value)
        {
            _lastPageLocalization = value;
            return this;
        }

        /// <summary>
        /// Set first page FiluetPager css class name
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager FirstPageCssClass(string value)
        {
        ...
        /// <summary>
        /// Set previous page FiluetPager css class name
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager PreviousPageCssClass(string value)
        {
        ...
        /// <summary>
        /// Set current page FiluetPager css class name
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager CurrentPageCssClass(string value)
        {
        ...
        /// <summary>
        /// Set individual page FiluetPager css class name
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager IndividualPageCssClass(string value)
        {
        ...
        /// <summary>
        /// Set next page FiluetPager css class name
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager NextPageCssClass(string value)
        {
        ...
        /// <summary>
        /// Set last page FiluetPager css class name
        /// </summary>
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager LastPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>FiluetPager</returns>
        public FiluetPager MainUlCssClass(string value)
        {
        ...
        /// <summary>
        /// Is FiluetPager empty (only one page)?
        /// </summary>
        /// <returns>
        ...
        /// </returns>
        protected virtual async Task<string> GenerateHtmlStringAsync(bool useDiv = true)
        {
            ...
            if (_showTotalSummary && (_model.TotalPages > 0))
            {
                ...
                links.Append(string.Format(await localizationService.GetResourceAsync(_currentPageLocalization), _model.PageIndex + 1, _model.TotalPages, _model.TotalItems));
            ...
            if (_showPagerItems && (_model.TotalPages > 1))
            {
                if (_showFirst)
                {
                    ...
                    if ((_model.PageIndex >= 3) && (_model.TotalPages > _individualPagesDisplayedCount))
                        links.Append(await CreatePageLinkAsync(1, await localizationService.GetResourceAsync(_firstPageLocalization), _firstPageCssClass));
                }
                ...
                if (_showPrevious)
                {
                    ...
                    if (_model.PageIndex > 0)
                        links.Append(await CreatePageLinkAsync(_model.PageIndex, await localizationService.GetResourceAsync(_previousPageLocalization), _previousPageCssClass));
                }
                ...
                if (_showIndividualPages)
                {
                    ...
                    for (var i = firstIndividualPageIndex; i <= lastIndividualPageIndex; i++)
                    {
                        if (_model.PageIndex == i)
                            links.AppendFormat(useDiv ? "<a class=\"" + _currentPageCssClass + "\">{0}</a>" : "<li class=\"" + _currentPageCssClass + "\"><span>{0}</span></li>", (i + 1));
                        else
                ...
                if (_showNext)
                {
                    ...
                    if ((_model.PageIndex + 1) < _model.TotalPages)
                        links.Append(await CreatePageLinkAsync(_model.PageIndex + 2, await localizationService.GetResourceAsync(_nextPageLocalization), _nextPageCssClass));
                }
                ...
                if (_showLast)
                {
                    ...
                    if (((_model.PageIndex + 3) < _model.TotalPages) && (_model.TotalPages > _individualPagesDisplayedCount))
                        links.Append(await CreatePageLinkAsync(_model.TotalPages, await localizationService.GetResourceAsync(_lastPageLocalization), _lastPageCssClass));
                }
            }
            ...
            {
                var tag = useDiv ? "div" : "ul";
                result = $"<{tag}{(string.IsNullOrEmpty(_mainUlCssClass) ? "" : " class=\"" + _mainUlCssClass + "\"")}>{result}</{tag}>";
            }
        ...
        /// </returns>
		protected virtual async Task<string> CreatePageLinkAsync(int pageNumber, string text, string cssClass, bool useDiv = true)
        {
            ...
            if (useDiv)
            {
                ...
                return await aBuilder.RenderHtmlContentAsync();
            }
            else
            {

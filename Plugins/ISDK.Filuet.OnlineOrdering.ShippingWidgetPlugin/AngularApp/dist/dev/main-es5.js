...
var AppModule = /** @class */ (function () {
    ...
    AppModule.prototype.ngDoBootstrap = function (appRef) {
        ...
        for (var nopViewComponentName in options) {
            var option = options[nopViewComponentName];
            var nopViewComponentElements = document.getElementsByClassName(nopViewComponentName);
            if (nopViewComponentElements.length > 0) {
                var ngComponentElement = document.createElement(option.selector);
...
var CheckoutShippingMethodTopWidgetComponent = /** @class */ (function () {
    function CheckoutShippingMethodTopWidgetComponent() {
    }
    CheckoutShippingMethodTopWidgetComponent.prototype.ngOnInit = function () {
    };
    ...
    return CheckoutShippingMethodTopWidgetComponent;
}());
...
var OrderMonthSelectComponent = /** @class */ (function () {
    function OrderMonthSelectComponent(_shippingService) {
        this._shippingService = _shippingService;
        this.blockedUI = false;
    }
    OrderMonthSelectComponent.prototype.ngOnInit = function () {
        var availableMonthsFiltered = this.availableMonths.filter(function (item) {
    ...
    OrderMonthSelectComponent.prototype.onOrderMonthChange = function () {
        var _this = this;
        this.blockedUI = true;
        this._shippingService.updateDistributorLimits(this.selectedOrderMonth.timestamp).subscribe(function () {
            _this.blockedUI = false;
        });
    };
    OrderMonthSelectComponent.ctorParameters = function () { return [
    ...
    return OrderMonthSelectComponent;
}());
...
var OrderSummaryContentBeforeWidgetComponent = /** @class */ (function () {
    function OrderSummaryContentBeforeWidgetComponent(_shippingService) {
        this._shippingService = _shippingService;
        this.loading = true;
    }
    OrderSummaryContentBeforeWidgetComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this._shippingService.getShippingCalculation().subscribe(function (data) {
            _this.shippingCalculation = data;
            _this.loading = false;
        });
    };
    OrderSummaryContentBeforeWidgetComponent.ctorParameters = function () { return [
        { type: src_app_services_shipping_service__WEBPACK_IMPORTED_MODULE_2__["ShippingService"] }
    ]; };
    ...
    return OrderSummaryContentBeforeWidgetComponent;
}());
...
var ShippingCountrySelectComponent = /** @class */ (function () {
    function ShippingCountrySelectComponent(_shippingService) {
        this._shippingService = _shippingService;
        this.blockedUI = false;
    }
    ShippingCountrySelectComponent.prototype.ngOnInit = function () {
        var contriesFiltered = this.contries.filter(function (item) {
            return item.isSelected;
        });
    ...
    ShippingCountrySelectComponent.prototype.onShippingCountryChange = function () {
        var _this = this;
        this.blockedUI = true;
        this._shippingService.setShippingCalculationOption(this.selectedShippingCountry).subscribe(function () {
            _this.blockedUI = false;
        });
    };
    ShippingCountrySelectComponent.ctorParameters = function () { return [
        { type: src_app_services_shipping_service__WEBPACK_IMPORTED_MODULE_2__["ShippingService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return ShippingCountrySelectComponent;
}());
...
var ShippingFormComponent = /** @class */ (function () {
    function ShippingFormComponent(_shippingService, _fb) {
        this._shippingService = _shippingService;
        this._fb = _fb;
    ...
    Object.defineProperty(ShippingFormComponent.prototype, "shippingMethod", {
        get: function () {
    ...
    Object.defineProperty(ShippingFormComponent.prototype, "shippingFormFieldNames", {
        get: function () {
    ...
    Object.defineProperty(ShippingFormComponent.prototype, "attributeControlTypeEnum", {
        get: function () {
    ...
    ShippingFormComponent.prototype.ngOnInit = function () {
        ...
        var controlsConfig = {};
        // FirstNameTextBox
        var required = this._shippingMethod.hiddenShippingFields.indexOf(src_app_constants_generated_ShippingFormFieldNames__WEBPACK_IMPORTED_MODULE_4__["ShippingFormFieldNames"].FirstNameTextBox) == -1
        ...
        this._shippingMethod.additionalShippingFields.forEach(function (element) {
        ...
        setTimeout(function () {
            _this.shippingForm.controls[src_app_constants_generated_ShippingFormFieldNames__WEBPACK_IMPORTED_MODULE_4__["ShippingFormFieldNames"].PhoneNumberTextBox].setValue(_this._shippingMethod.phoneNumber);
        }, 0);
        this.shippingFormGroup.emit(this.shippingForm);
    };
    ShippingFormComponent.prototype.findSelectedCity = function () {
        var citySelected = this._shippingMethod.city;
        if (citySelected) {
            var citiesFiltered = this.cities.filter(function (city) {
    ...
    ShippingFormComponent.prototype.loadPickupPoints = function (isInit) {
        var _this = this;
        ...
        if (this._shippingMethod.city) {
            ...
            this._shippingService.getPickupPoints(filter).subscribe(function (data) {
                _this.pickupPoints = data;
                if (isInit) {
                    _this.selectedPickupPoint = _this.findSelectedPickupPoint();
                    _this.shippingForm.controls[src_app_constants_generated_ShippingFormFieldNames__WEBPACK_IMPORTED_MODULE_4__["ShippingFormFieldNames"].AddressDropdownList].setValue(_this.selectedPickupPoint);
                    _this.shippingFormGroup.emit(_this.shippingForm);
                }
                _this.loadingPickupPoints = false;
            });
        }
        else {
            this.loadingPickupPoints = false;
    ...
    ShippingFormComponent.prototype.findSelectedPickupPoint = function () {
        var _this = this;
        if (this._shippingMethod.pickupPointId == null) {
            return null;
        }
        if (this.pickupPoints) {
            var items = this.pickupPoints.filter(function (item) {
                return item.id == _this._shippingMethod.pickupPointId.toString();
            });
            if (items.length > 0) {
                return items[0];
            }
    ...
    ShippingFormComponent.prototype.onValueChange = function (fieldName) {
        ...
        var additionalShippingField = this._shippingMethod.additionalShippingFields.find(function (item) {
    ...
    ShippingFormComponent.prototype.isHidden = function (shippingFormFieldName) {
...
var ShippingMethodSelectComponent = /** @class */ (function () {
    function ShippingMethodSelectComponent(_shippingService) {
        this._shippingService = _shippingService;
        this.loading = false;
        this.shippingMethodValid = {};
        this.blockedUI = false;
    }
    ShippingMethodSelectComponent.prototype.ngOnInit = function () {
        this.loadData();
    };
    ShippingMethodSelectComponent.prototype.ngAfterViewInit = function () {
    ...
    ShippingMethodSelectComponent.prototype.loadData = function () {
        var _this = this;
        this.loading = true;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(this._shippingService.getShippingMethods(), this._shippingService.getCitiesOfSelectedShippingComputation())
            ...
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), shippingMethodList = _b[0], cities = _b[1];
            _this.shippingMethodList = shippingMethodList;
            _this.cities = cities;
            _this.loading = false;
        });
    };
    ShippingMethodSelectComponent.prototype.saveData = function (event) {
        var selectedShippingMethod = this.shippingMethodList.filter(function (item) {
            return item.isSelected;
        })[0];
        ...
        this.blockedUI = true;
        this._shippingService.updateInfo(selectedShippingMethod).subscribe(function () {
            event.detail.shippingMethod.saveCallback();
        });
    };
    ShippingMethodSelectComponent.prototype.onTabOpen = function (e) {
        this.shippingMethodList.forEach(function (element) { element.isSelected = false; });
        this.shippingMethodList[e.index].isSelected = true;
    };
    ShippingMethodSelectComponent.prototype.checkModel = function (e, shippingMethod) {
        this.shippingMethodValid[shippingMethod.displayOrder] = e.valid;
    };
    ShippingMethodSelectComponent.prototype.resetLoadWaitingEvent = function (event) {
        this.blockedUI = false;
        event.detail.shippingMethod.resetLoadWaitingCallback();
    };
    ShippingMethodSelectComponent.ctorParameters = function () { return [
        { type: src_app_services_shipping_service__WEBPACK_IMPORTED_MODULE_2__["ShippingService"] }
    ]; };
    ...
    return ShippingMethodSelectComponent;
}());
...
var NopViewComponentNames = /** @class */ (function () {
    function NopViewComponentNames() {
    }
...
var ResourceKeys = /** @class */ (function () {
...
var ShippingFormFieldNames = /** @class */ (function () {
    function ShippingFormFieldNames() {
    }
...
var LocalizerPipe = /** @class */ (function () {
    function LocalizerPipe(_commonService) {
        this._commonService = _commonService;
    }
    LocalizerPipe.prototype.transform = function (resourceKey) {
        var promise = this._commonService.getPluginAllLocaleStringResourcesOfCache().toPromise();
        return promise.then(function (resources) {
            if (_constants_generated_ResourceKeys__WEBPACK_IMPORTED_MODULE_3__["ResourceKeys"][resourceKey]) {
                var resourceName = _constants_generated_ResourceKeys__WEBPACK_IMPORTED_MODULE_3__["ResourceKeys"][resourceKey];
    ...
    LocalizerPipe.ctorParameters = function () { return [
...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.post = function (url, request, headers) {
        return this._http
    ...
    BaseService.prototype.postOfCache = function (url, request) {
        if (!this._cache[url]) {
            this._cache[url] = this._http
                .post(url, request)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["shareReplay"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (data) {
                return data;
            }));
        }
        return this._cache[url];
    };
    BaseService.prototype.getOfCache = function (url) {
        if (!this._cache[url]) {
...
var CommonService = /** @class */ (function (_super) {
    ...
    CommonService.prototype.getPluginAllLocaleStringResourcesOfCache = function () {
        var _this = this;
        return this.getOfCache('/api/shipping/get_plugin_all_resources').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            _this._resources = data;
            return data;
        }));
    };
    CommonService.prototype.getResource = function (resourceKey) {
        if (_constants_generated_ResourceKeys__WEBPACK_IMPORTED_MODULE_5__["ResourceKeys"][resourceKey]) {
            var resourceName = _constants_generated_ResourceKeys__WEBPACK_IMPORTED_MODULE_5__["ResourceKeys"][resourceKey];
...
var ShippingService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ShippingService, _super);
    function ShippingService(http) {
        var _this = _super.call(this, http) || this;
        _this.endpoint = '/api/shipping';
        return _this;
    }
    ShippingService.prototype.getShippingMethods = function () {
        return this.get(this.endpoint + "/shipping_methods");
    };
    ShippingService.prototype.getPickupPoints = function (filter) {
        return this.post(this.endpoint + "/pickup_points", filter);
    };
    ShippingService.prototype.getCitiesOfSelectedShippingComputation = function () {
        return this.get(this.endpoint + "/cities_of_selected_shipping_computation");
    };
    ShippingService.prototype.updateInfo = function (model) {
        return this.post(this.endpoint + "/update_info", model);
    };
    ShippingService.prototype.getShippingCalculation = function () {
        return this.get(this.endpoint + "/get_shipping_calculation");
    };
    ShippingService.prototype.setShippingCalculationOption = function (model) {
        return this.post(this.endpoint + "/set_shipping_computation_option", model);
    };
    ShippingService.prototype.updateDistributorLimits = function (value) {
